...
const Hero = () => {
  ...
  return (
    <section className="flex flex-col justify-center items-center w-full max-lg:py-24 lg:min-h-[95vh] lg:sticky lg:top-0 z-0 bg-primary text-primary-content overflow-hidden">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        className="grid lg:grid-cols-12 gap-12 md:gap-16 max-w-7xl px-4"
      >
        <motion.div
        ...
        >
          <div className="bg-base-200 text-base-content rounded-3xl p-6 md:p-8 transform hover:scale-[1.02] transition-transform duration-300">
            ...
            <div className="space-y-3">
              {feedbackItems.map((item, index) => (
                <motion.div
                  ...
                  className="relative p-4 bg-base-100 rounded-box flex justify-between gap-6 hover:bg-base-300 transition-colors duration-200"
                >
                  {item.hasShipTag && (
        ...
        <motion.div
          ...
          className="max-lg:order-first lg:col-span-7 flex flex-col items-center lg:items-start gap-10 justify-center lg:justify-start max-w-3xl text-center lg:text-left"
        >
          <motion.h1
            initial={{ opacity: 0, y: -20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.6 }}
            className="text-5xl md:text-6xl lg:!text-7xl tracking-[-0.01em] leading-none font-black"
          >
            Ship features users{" "}
            <span className="relative">
              ...
              <motion.span
                ...
                className="absolute bottom-2 left-0 h-3 bg-primary-content/20 -z-0"
              />
            </span>{" "}
            want
          </motion.h1>
          <motion.p
            ...
            className="text-lg leading-relaxed text-base-content-secondary max-w-[450px]"
          >
          ...
          >
            ...
            <motion.p
              ...
              className="text-sm text-base-content-secondary/80 mt-2"
            >
      ...
      <div className="grid lg:grid-cols-3 gap-16 mt-24 lg:mt-16 xl:mt-24 w-full max-w-7xl px-4">
        ...
        >
          ...
          <motion.div
            ...
            className="leading-relaxed space-y-2 max-w-md mx-auto text-center"
          >
          ...
          >
            ...
            <div>
              ...
              <p className="opacity-80 text-sm">418K followers on ��</p>
            </div>
          </motion.div>
        </motion.div>
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6, delay: 0.4 }}
          className="mx-auto my-auto max-lg:order-first"
        >
          <motion.a
            href="#"
            className=""
